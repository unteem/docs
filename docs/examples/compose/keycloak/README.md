...
```bash
mkdir keycloak
curl -o compose.yaml https://github.com/suitenumerique/docs/tree/main/docs/docs/examples/compose/keycloak/compose.yaml
curl -o env https://github.com/suitenumerique/docs/tree/main/docs/docs/examples/compose/keycloak/env
```

### Step 2:. Update `env` file 

The follwing variables need to be updated with your own values, others can be left as is:
```env
POSTGRES_PASSWORD=<generate postgres password>
KC_HOSTNAME=https://id.example.org # Change with your own URL
