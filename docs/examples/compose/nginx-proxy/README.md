...
```bash
mkdir nginx-proxy
curl -o compose.yaml https://github.com/suitenumerique/docs/tree/main/docs/docs/examples/compose/nginx-proxy/compose.yaml
curl -o env https://github.com/suitenumerique/docs/tree/main/docs/docs/examples/compose/nginx-proxy/env
```
